...
const SettingsScreen: React.FC<Props> = ({ navigation, route }: Props) => {
    ...
    const getSettings = async () => {
        ...
        if (settingsObject) {
            ...
            setIsFallbackActive(settingsObject.isFallbackActive)
    ...
    const securityTuttons: Button[] = [
        ...
        {
            name: 'Use Device Biometric Fallback',
            tip: 'In the case the device biometric fails, provide an alternative',
            icon: '',
    ...
    useEffect(() => {
        saveSettings()
    }, [isBiometricsActive, isMultiAccessActive, isFallbackActive])
